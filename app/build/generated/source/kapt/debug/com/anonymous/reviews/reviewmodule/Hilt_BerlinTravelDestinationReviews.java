...
public abstract class Hilt_BerlinTravelDestinationReviews extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BerlinTravelDestinationReviews() {
    super();
  }

  Hilt_BerlinTravelDestinationReviews(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BerlinTravelDestinationReviews_GeneratedInjector) this.generatedComponent()).injectBerlinTravelDestinationReviews(UnsafeCasts.<BerlinTravelDestinationReviews>unsafeCast(this));
    }
  }
